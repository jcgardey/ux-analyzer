...
class PredictionModels:
    ...
    def train_models(self):
        ...
        date_select_model = self.train_widget_model(SklearnModel,os.path.join(os.path.realpath(os.path.dirname(__file__)),"training/DateSelect.csv"),self.common_features_excluded + ["optionsCount", "interactions", "optionsSelected"])
